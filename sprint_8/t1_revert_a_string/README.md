...
Всего слов не более `1000`, длина каждого из них от `1` до `100` символов. Слова состоят из строчных букв 
...
> Два указателя. Cтавим указатель в самый конец строки и идем влево, вычленяя слова вручную. 
> Как только нашли слово — добавляем его в массив результата.