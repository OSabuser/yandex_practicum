...
Есть матрица размера $m \times n$. Нужно написать функцию, которая её транспонирует.

Транспонированная матрица получается из исходной заменой строк на столбцы.

Например, для матрицы `A` (слева) транспонированной будет следующая матрица (справа):
![](../pics/example_0.png)

## Формат ввода

В первой строке задано число $n$, $n$ — количество строк матрицы.
Во второй строке задано $m$ - число столбцов,$m$ и $n$ не превосходят $1000$. В следующих $n$
строках задана матрица. Числа в ней не превосходят по модулю  $1000$.
